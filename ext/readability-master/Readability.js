        ...
        this.log = function () {
            if (typeof console !== "undefined") {
                ...
                var msg = Array.prototype.map
                    .call(arguments, (x) => (x && x.nodeName ? logNode(x) : x))
                    .join(" ");
    ...
    _getArticleTitle() {
        ...
        if (new RegExp(`\\s[${titleSeparators}]\\s`).test(curTitle)) {
            ...
            const allSeparators = Array.from(
                origTitle.matchAll(
                    new RegExp(`\\s[${titleSeparators}]\\s`, "gi"),
                ),
            );
        ...
        while (true) {
            ...
            while (node) {
                ...
                if (
                    ...
                    this._headerDuplicatesTitle(node)
                ) {
                    this.log(
                        "Removing header: ",
                ...
                if (stripUnlikelyCandidates) {
                    ...
                    if (
                        this.UNLIKELY_ROLES.includes(node.getAttribute("role"))
                    ) {
                        this.log(
                    ...
                    while (childNode) {
                        ...
                        if (this._isPhrasingContent(childNode)) {
                            ...
                            do {
                                ...
                                childNode &&
                                this._isPhrasingContent(childNode)
                            );
    ...
    _getLinkDensity(element) {
        ...
        this._forEachNode(
            ...
            function (linkNode) {
                ...
                var coefficient =
                    href && this.REGEXPS.hashUrl.test(href) ? 0.3 : 1;
