                    ...
                    click: (item, window) => {
                        if (isFocusMode) {
                            ...
                            windows
                                .getAll()
                                .forEach((win) =>
                                    sendIPCToWindow(win, "exitFocusMode"),
                                );
                        } else {
                            isFocusMode = true;
                            windows
                                .getAll()
                                .forEach((win) =>
                                    sendIPCToWindow(win, "enterFocusMode"),
                                );
                ...
                ...(isDevelopmentMode || isDebuggingEnabled
                    ? [
                          ...
                          },
                          {
                              ...
                              click: (item, focusedWindow) => {
                                  placesWindow.webContents.openDevTools({
                                      mode: "detach",
                                  });
                              },
                          },
            ...
            ? [
                  {
                      ...
                      submenu: [
                          ...
                          },
                          {
                              ...
                              type: "checkbox",
                              checked:
                                  settings.get("windowAlwaysOnTop") || false,
                              click: (item, window) => {
            ...
            : []),
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click: () => {
                        openTabInWindow(
                            "https://github.com/minbrowser/min/issues/new",
                        );
                    },
                },
                {
                    ...
                    click: () => {
                        openTabInWindow(
                            "https://minbrowser.github.io/min/tour/",
                        );
                    },
                },
                {
