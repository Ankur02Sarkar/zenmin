...
const bookmarkEditor = {
    ...
    getTagElement: (tag, selected, onClick, options = {}) => {
    ...
    render: async (url, options = {}) => {
        ...
        if (!options.simplified) {
            ...
            saveButton.className =
                "action-button always-visible i carbon:checkmark";
        ...
        delButton.className =
            "action-button always-visible bookmark-delete-button i carbon:trash-can";
        ...
        places
            .getSuggestedTags(bookmarkEditor.currentInstance.bookmark.url)
            .then((suggestions) => {
    ...
    show: (url, replaceItem, onClose, options) => {
