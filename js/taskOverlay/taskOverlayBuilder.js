...
var TaskOverlayBuilder = {
    create: {
        task: {
            collapseButton: (taskContainer, task) => {
            ...
            nameInputField: (task, taskIndex) => {
                var input = document.createElement("input");
                input.classList.add("task-name");

                var taskName = l("defaultTaskName").replace(
                    "%n",
                    taskIndex + 1,
                );
            ...
            deleteButton: (container, task) => {
                var deleteButton = document.createElement("button");
                deleteButton.className =
                    "task-delete-button i carbon:trash-can";
            ...
            infoContainer: (task) => {
                ...
                if (lastTabTitle) {
                    ...
                    lastTabEl.textContent =
                        searchbarUtils.getRealTitle(lastTabTitle);
                }
            ...
            container: function (task, taskIndex, events) {
                ...
                var tabContainer = TaskOverlayBuilder.create.tab.container(
                    task,
                    events,
                );
        ...
        tab: {
            element: (tabContainer, task, tab, events) => {
                var data = {
