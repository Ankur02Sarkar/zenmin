...
const pageTranslations = {
    ...
    getLanguageList: () => {
        const formatter = new Intl.DisplayNames([navigator.language], {
            type: "language",
        });
        ...
        const topLangs = allLangs.filter((lang) =>
            userPrefs.includes(lang.code),
        );
        ...
        const otherLangs = allLangs.filter(
            (lang) => !userPrefs.includes(lang.code) && lang.code !== "en",
        );
