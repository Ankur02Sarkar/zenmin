class TabList {
    ...
    add(tab = {}, options = {}, emit = true) {
        ...
        if (emit) {
            this.parentTaskList.emit(
                ...
                newTab,
                options,
                this.parentTaskList.getTaskContainingTab(tabId).id,
            );
        }
    ...
    destroy(id, emit = true) {
        ...
        tasks
            ...
            .tabHistory.push(this.toPermanentState(this.tabs[index]));
    ...
    splice(...args) {
        const containingTask = this.parentTaskList.find(
            (t) => t.tabs === this,
        ).id;
