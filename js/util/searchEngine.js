...
var searchEngines = {
    DuckDuckGo: {
        name: "DuckDuckGo",
        searchURL: "https://duckduckgo.com/?q=%s&t=zenmin",
        suggestionsURL: "https://ac.duckduckgo.com/ac/?q=%s&type=list&t=zenmin",
        queryParam: "q",
    },
    Google: {
        name: "Google",
    ...
    Yahoo: {
        ...
        suggestionsURL:
            "https://search.yahoo.com/sugg/os?command=%s&output=fxjson",
        queryParam: "p",
    },
    Baidu: {
        name: "Baidu",
        ...
        suggestionsURL:
            "https://www.baidu.com/su?wd=%s&action=opensearch&ie=utf-8",
        queryParam: "wd",
    },
    StartPage: {
        name: "StartPage",
        ...
        suggestionsURL:
            "https://www.startpage.com/cgi-bin/csuggest?query=%s&format=json",
        queryParam: "q",
    },
    Ecosia: {
        name: "Ecosia",
...
var searchEngine = {
    getCurrent: () => currentSearchEngine,
    getSearch: (url) => {
        var urlObj;
        try {
            urlObj = new URL(url);
